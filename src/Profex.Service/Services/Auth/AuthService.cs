...
public class AuthService : IAuthService
{
    ...
    //private const int CACHED_MINUTES_FOR_REGISTER = 600000000;
    //private const int CACHED_MINUTES_FOR_VERIFICATION = 500000;
    ...
    //    var hashresult = PasswordHasher.Verify(loginDto.Password, user.Password_hash, user.Salt);
    ...
    //    //(_memoryCache.TryGetValue(dto.PhoneNumber, out RegisterDto cachedRegisterDto))
    //    if (_memoryCache.TryGetValue(REGISTER_CACHE_KEY + dto.PhoneNumber, out RegisterDto cashedegisterDto))
    //    {
    //        cashedegisterDto.FirstName = cashedegisterDto.FirstName;
